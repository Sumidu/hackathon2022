...
begin
function simple_SEIR(x, p, t; γ = 1/18, R₀ = rnaught, σ = 1/3.2, ω = 0.00)
    s, e, i, r = x

    return [-γ*R₀*s*i + ω * r;      # ds/dt = -γR₀si
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "2116afff7bf1f02acf9c6f83194d6fcd27c28046"
